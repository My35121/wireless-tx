...
osEventFlagsId_t xDataProcessEventHandle;
const osEventFlagsAttr_t xDataProcessEvent_attributes = {
  .name = "xDataProcessEvent"
};
...
extern void StartDataProcessTask(void *argument);
...
void MX_FREERTOS_Init(void) {
  ...
  /* Create the event(s) */
  /* creation of xDataProcessEvent */
  xDataProcessEventHandle = osEventFlagsNew(&xDataProcessEvent_attributes);
