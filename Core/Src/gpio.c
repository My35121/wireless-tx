...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LED_W_Pin|LED_G_Pin|LED_B_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LED_W_Pin LED_G_Pin LED_B_Pin */
  GPIO_InitStruct.Pin = LED_W_Pin|LED_G_Pin|LED_B_Pin;
